...
@NamedStoredProcedureQueries({
		@NamedStoredProcedureQuery(name = "upWeb_GetApprovalItemList", procedureName = "dbo.upWeb_GetApprovalItemList", resultClasses = ApprovalItem.class, parameters = {
