...
@NamedStoredProcedureQueries({
	@NamedStoredProcedureQuery(name = "upWeb_GetEditItemDetailList", procedureName = "dbo.upWeb_GetEditItemList", parameters = {
	...
	}, resultClasses = com.fashiongo.cms.model.EditDetailItem.class)
})

@Entity
public class EditDetailItem {
